const adminCreateGame = (e)=> {
  ...
  let data = {'title':title, "blob":image, "blob_name":blob_name, "weight":weight, "description": description, "device":media, "engine":engine, "status":status, "type":type, "creation_date":creation_date, "end_creation":delivery_date,"players":players, "total-budget":budget};
...
const doFetch = await fetch('createGame.php', 
  {
      method: "POST",
  ...
  window.location = "adminCreateGame.php";
