const adminCreateRole = (e)=>{
  ...
  let data = {"firstname":firstname, "name":name, "email":email, "pwd":pwd, "role":role};
...
const fetchRoleDetails = await fetch('adminCreateRole.php', 
  {
      method: "POST",
  ...
  window.location = "adminCreateProducerManager.php";
}
