...
<head>
  ...
  <script src="../js/fetchUserRegisterPage.js"></script>
    ...
    <div id="responsive-navbar" class="responsive-navbar" style="display:flex;">
      ...
      if (!is_null($user_name) && !is_null($user_email)) {
        ...
        if (!is_null($role) && !strcmp($role, "admin")) {
          echo "<li><a href=\"./pages/adminDashboardPage.php\">Tableau de Bord Admin</a></li>";
        }
  ...
  <div class="registerContainer">
    ...
    <form style="width: 30%;">
      <ul class="wrapper">
        ...
        <li class="form-row">
          <button type="button" id="submit-button">M'enregistrer</button>
