...
<head>
  ...
  <link rel="stylesheet" href="../css/userBrowseVideoGames.css">
  <link rel="stylesheet" href="../css/responsive-navbar.css">
  <script src="../js/fetchVideoGames.js"></script>
...
<body id="browseVideoGamesBody">
  ...
  <header id="indexHeader" class="index-header">
    ...
    if (!is_null($user_name) && !is_null($user_email)) {
      echo "<div hidden id=\"email-user\">" . $user_email . "</div>";
      echo <<<EOL
     ...
     EOL;
      echo "
     <div style=\"display:block;justify-content:start;padding-right:2rem;padding-left:2rem; font-size:0.8rem;\">
      Bienvenue
      " . $user_name . "
      <br>
      accès : " . $role . "
        ...
        <form action="../backend/updateGameDetails.php" method="post">
          <ul class="wrapper">
            <li class="form-row">
              ...
              <input type="text" name="title" id="title" required readonly />
            </li>
            <li class="form-row">
              <label for="description">Description</label>
              <textarea id="description" name="description" rows="3" cols="80" required readonly></textarea>
            </li>
            <li id="video-game-weight" class="form-row">
              <label for="weight">Priorité</label>
              <input type="number" id="weight" name="weight" required readonly></input>
            </li>
            <li id="video-game-studio" class="form-row">
              <label for="studio">Studio</label>
              <input type="text" id="studio" value="Gamesoft" readonly readonly></input>
            </li>
