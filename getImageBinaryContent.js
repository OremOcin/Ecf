function getBlob(e) {
  ...
  if(e.target.files) {
  {
    ...
    {         
     ...
     const dataTransfer = new DataTransfer(); dataTransfer.items.add(file);//your file(s) reference(s) 
     document.getElementById('video-game-blob').files = dataTransfer.files;
     document.getElementById('screenshot#_video-game-blob').src = reader.result;
