...
async function fetchNews(data) {
  const doFetchNews = await fetch("../backend/publishNews.php", {
    method: "POST",
...
async function fetchAllNews() {
  ...
  const doFetchAllNews = await fetch("../backend/fetchAllNews.php", {
    method: "POST",
    body: JSON.stringify({}),
    headers: {
      Accept: "application/json",
...
async function FetchAllDevGames() {
  ...
  const doFetchDevGames = await fetch("../backend/fetchDevGames.php", {
    method: "POST",
    body: JSON.stringify({}),
    headers: {
      Accept: "application/json",
