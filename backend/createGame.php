...
session_start();
// Vous ne devez pas utiliser la base de données "root". Ceci est juste pour l'exemple. La méthode recommandée est de créer une base de données dédiée (et un utilisateur) dans PhpMyAdmin et de l'utiliser ensuite ici.
$hostname = '127.0.0.1';
$user = 'root';
$password = 'toto';
$database = 'toto';
